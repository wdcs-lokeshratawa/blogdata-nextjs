        ...
        {blogData?.map((item, index) => {
          return (
              ...
              <div
                ...
                key={item.id}
                className={`${styles.box} relative bg-white px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto
                 sm:max-w-lg sm:rounded-lg sm:px-10 text-center p-10 rounded-lg row-span-2 transform transition duration-500 hover:scale-110`}
              >
